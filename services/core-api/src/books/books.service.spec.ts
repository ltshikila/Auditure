...
describe('BooksService', () => {
  ...
  describe('uploadBook', () => {
    ...
    it('should throw BadRequestException if file is missing', async () => {
      await expect(
        service.uploadBook(mockUserId, null, mockCreateBookDto)
  ...
  describe('getExtractedText', () => {
    ...
    it('should throw BadRequestException if extraction not completed', async () => {
      ...
      await expect(
        service.getExtractedText(mockUserId, mockBook.id)
      ).rejects.toThrow(BadRequestException);
    });
  ...
  describe('retryExtraction', () => {
    ...
    it('should throw BadRequestException if extraction not failed', async () => {
      ...
      await expect(
        service.retryExtraction(mockUserId, mockBook.id)
      ).rejects.toThrow(BadRequestException);
    ...
    it('should throw NotFoundException if book does not exist', async () => {
      ...
      await expect(
        service.retryExtraction(mockUserId, 'non-existent-id')
  ...
  describe('getExtractedText - Error Handling', () => {
    it('should throw NotFoundException if book does not exist', async () => {
      ...
      await expect(
        service.getExtractedText(mockUserId, 'non-existent-id')
      ).rejects.toThrow(NotFoundException);
    });
