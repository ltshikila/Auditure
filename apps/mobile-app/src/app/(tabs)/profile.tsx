...
export default function Profile() {
  ...
  return (
    <SafeAreaView className="flex-1 bg-brand-beige">
      ...
      >
        {/* Header */}
        <Text className="font-inter-bold text-3xl text-gray-900 mb-1">Profile</Text>
        <Text className="font-jakarta text-gray-500 mb-8">Manage your account and preferences</Text>
        ...
        >
              ...
              <View className="flex-row">
                <TouchableOpacity
                  onPress={() => {
                    ...
                    setEditDateOfBirth(profile?.dateOfBirth ? new Date(profile.dateOfBirth) : null);
                  }}
                  className="mr-4"
                >
          ...
          <View className="items-center mb-6">
            ...
            {profile?.isEmailVerified && (
              <View className="flex-row items-center mt-1">
                ...
                <Text className="font-inter text-xs text-green-600 ml-1">Verified</Text>
              </View>
            )}
          </View>
          ...
          {isEditing ? (
            <View>
              <View className="mb-4">
                <Text className="font-jakarta text-gray-700 mb-1 ml-1">First Name</Text>
                <TextInput
                  value={editFirstName}
              ...
              <View className="mb-4">
                <Text className="font-jakarta text-gray-700 mb-1 ml-1">Last Name</Text>
                <TextInput
                  value={editLastName}
              ...
              <View className="mb-2">
                <Text className="font-jakarta text-gray-700 mb-1 ml-1">Date of Birth</Text>
                <TouchableOpacity
            ...
            <View>
              ...
              <View className="flex-row justify-between py-3 border-b border-gray-100">
                ...
                <Text className="font-inter-medium text-gray-900">{profile?.email}</Text>
              </View>
        ...
        {subscription && (
          ...
          >
            ...
            <View className="bg-[#F5F5F0] rounded-xl p-4">
              <Text className="font-inter-medium text-gray-700 mb-3">Monthly Usage</Text>

              {/* Gemini Episodes */}
              <View className="mb-3">
                <View className="flex-row justify-between mb-1">
                  <Text className="font-inter text-gray-600 text-sm">Gemini Episodes</Text>
              ...
              <View>
                <View className="flex-row justify-between mb-1">
                  <Text className="font-inter text-gray-600 text-sm">Standard Episodes</Text>
                  <Text className="font-inter text-gray-900 text-sm">
        ...
        {settings && (
          ...
          >
            ...
            <SettingItem
              ...
              onValueChange={(value) => handleUpdateSetting('pushNotificationsEnabled', value)}
            />
            <SettingItem
              icon="mail"
              label="Email Notifications"
              value={settings.emailNotificationsEnabled}
              onValueChange={(value) => handleUpdateSetting('emailNotificationsEnabled', value)}
            />
            <SettingItem
              icon="megaphone"
              label="Marketing Emails"
              value={settings.marketingEmailsEnabled}
              onValueChange={(value) => handleUpdateSetting('marketingEmailsEnabled', value)}
            />
          </View>
        )}
        ...
        {settings && (
          ...
          >
            ...
            <SettingItem
              ...
              onValueChange={(value) => handleUpdateSetting('showListeningActivity', value)}
            />
          </View>
        )}
        ...
        {settings && (
          ...
          >
            ...
            <SettingItem
              ...
              onValueChange={(value) => handleUpdateSetting('downloadOverWifiOnly', value)}
            />
            ...
            <View className="py-4 border-b border-gray-100">
              <View className="flex-row items-center mb-3">
                ...
                <Text className="font-inter text-gray-900">Default Playback Speed</Text>
              </View>
                ...
                {[0.75, 1.0, 1.25, 1.5, 2.0].map((speed) => (
                  <TouchableOpacity
                    ...
                    className={`px-4 py-2 rounded-full ${
                      settings.playbackSpeed === speed ? 'bg-brand-gold' : 'bg-gray-100'
                    }`}
                  >
                    <Text
                      className={`font-inter-medium text-sm ${
                        settings.playbackSpeed === speed ? 'text-white' : 'text-gray-700'
                      }`}
                    >
                      {speed}x
                    </Text>
        ...
        <View className="flex-1 bg-black/50 items-center justify-center px-6">
          <View className="bg-white rounded-2xl p-6 w-full max-w-sm">
            ...
            <View className="flex-row gap-3">
              ...
              >
                <Text className="font-inter-medium text-gray-700 text-center">Cancel</Text>
              </TouchableOpacity>
              <TouchableOpacity
