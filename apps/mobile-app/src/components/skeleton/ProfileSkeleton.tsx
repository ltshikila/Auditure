    ...
    return (
        <SkeletonProvider>
            <View style={{ paddingHorizontal: 20, paddingBottom: 25 }}>
                ...
                <View className="bg-[#F5F5F0] dark:bg-brand-dark-surface rounded-2xl p-5 mb-6" style={{ shadowColor: '#000', shadowOpacity: 0.05, shadowRadius: 10, elevation: 2 }}>
                ...
                {/* Account Card */}
                <View className="bg-[#F5F5F0] dark:bg-brand-dark-surface rounded-2xl p-5" style={{ shadowColor: '#000', shadowOpacity: 0.05, shadowRadius: 10, elevation: 2 }}>
