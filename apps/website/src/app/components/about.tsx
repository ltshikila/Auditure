...
export function About() {
  return (
    <section id="about" className="py-20 md:py-28 bg-[#1A1512]">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h2 className="font-['EB_Garamond',serif] text-[#EDE4D6] text-4xl md:text-5xl mb-4">
            About Auditure Studios
          </h2>
          <p className="font-['EB_Garamond',serif] text-[#A2907C] text-lg md:text-xl max-w-2xl mx-auto">
        ...
        <div className="max-w-3xl mx-auto mb-20">
          <div className="space-y-6 font-['EB_Garamond',serif] text-[#EDE4D6] text-base md:text-lg leading-relaxed">
            <p>
        ...
        <div className="max-w-2xl mx-auto">
          <h3 className="font-['EB_Garamond',serif] text-[#EDE4D6] text-3xl mb-8 text-center">
            The Team
          </h3>

          <div className="bg-[#221A16] rounded-[2px] p-8 md:p-10 border border-[#EDE4D6]/12">
            <div className="flex flex-col md:flex-row items-center md:items-start gap-6">
              ...
              <div className="flex-1 text-center md:text-left">
                <h4 className="font-['EB_Garamond',serif] text-[#EDE4D6] text-2xl mb-1">
                  Lubabalo Tshikila
                </h4>
                <p className="font-['EB_Garamond',serif] text-[#C2A14D] text-sm mb-4 tracking-wide uppercase">
                  Founder
                </p>
                <p className="font-['EB_Garamond',serif] text-[#A2907C] text-base leading-relaxed mb-5">
                ...
                <a
                  ...
                  className="inline-flex items-center gap-2 font-['EB_Garamond',serif] text-[#C2A14D] hover:text-[#B00003] transition-colors"
                >
