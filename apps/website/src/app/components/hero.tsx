        ...
        <div className="max-w-3xl mx-auto text-center flex flex-col items-center gap-8">
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <a
              ...
              className="bg-[#920002] hover:bg-[#760002] text-white px-8 py-4 rounded-[15px] shadow-md font-['Plus_Jakarta_Sans',sans-serif] flex items-center justify-center gap-3 transition-colors"
            >
              <img src={googlePlayIcon} alt="" width="24" height="24" />
              Download on Android
            </a>
            <button className="bg-white border-2 border-[#2f2f2f] text-[#2f2f2f] px-8 py-4 rounded-[15px] font-['Plus_Jakarta_Sans',sans-serif] flex items-center justify-center gap-3 cursor-default">
