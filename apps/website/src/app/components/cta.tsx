      ...
      <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 text-center relative z-10">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
          <a
            ...
            className="bg-[#920002] hover:bg-[#760002] text-white px-10 py-5 rounded-[15px] shadow-lg font-['Plus_Jakarta_Sans',sans-serif] text-lg flex items-center justify-center gap-3 transition-colors"
          >
            <img src={googlePlayIcon} alt="" width="28" height="28" />
            Download on Android
          </a>
          <button className="bg-white/10 text-white border-2 border-white/30 px-10 py-5 rounded-[15px] font-['Plus_Jakarta_Sans',sans-serif] text-lg flex items-center justify-center gap-3 cursor-default">
